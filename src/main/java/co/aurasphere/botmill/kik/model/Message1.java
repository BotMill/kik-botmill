...
public class Message1 {
	 ...
	 *            the type time
	 */
	public Message1(String msg, String type, int typeTime) {
		this.body = msg;
		this.type = type;
	 ...
	 *            the type
	 */
	public Message1(String msg, String type) {
	 ...
	 *            the kik api
	 */
	public Message1(String chatId, String id, String type, String from, String body, int timestamp,
	 ...
	 * @return the message
	 */
	public Message1 setKeyboard(Keyboard keyboard) {
	...
	public void sendReadRecepit() {
		...
		main.addProperty("type", Message1.Type.READ_RECEPT);
